...
class ClosedComplaints extends StatefulWidget {
  const ClosedComplaints({super.key});

  @override
  State<ClosedComplaints> createState() => _ClosedComplaintsState();
}

class _ClosedComplaintsState extends State<ClosedComplaints> {
      ...
      child: StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(child: Text('No closed complaints.'));
          }
